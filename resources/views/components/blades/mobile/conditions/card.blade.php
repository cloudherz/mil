                            ...
                            <div class="S-HEADING-wrapper">
                                <div class="S-HEADING-carcass">
                                    ...
                                    <div class="S-HEADING-text">
                                        <h3 class="T-HEADING-text T-HEADING-text_{{ $color }} TYPO-M-PRESET-CORE_H3">{{ $heading }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="S-CONTENT-description">
                            <p class="TYPO-M-PRESET-CORE_P">{!! $description !!}</p>
                        </div>
                        <div class="S-CONTENT-price">
                            <p class="T-CONTENT-price T-CONTENT-price_{{ $color }} TYPO-M-PRESET-CORE_H3_LIGHT">{{ $price }}</p>
                        </div>
                    </div>
                </div>
            </div>
