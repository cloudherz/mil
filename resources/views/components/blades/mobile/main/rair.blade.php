@php
    $background = Blade::render("<x-svg.backgrounds.mobile.rair_{$number} class=\"I-BACKGROUND-shape I-BACKGROUND-shape_{$number}\" />");
@endphp

<div class="S-MAIN-rair" id="rair_{{ $number }}-m">
                ...
                <div class="S-CONTENT-wrapper">
                    <div class="S-CONTENT-carcass">
                        <div class="S-CONTENT-title">
                            <h2 class="TYPO-M-PRESET-CORE_H2">{!! $heading !!}</h2>
                        </div>
                        <div class="S-CONTENT-text">
                            <p class="TYPO-M-PRESET-CORE_P">{!! $text !!}</p>
                        </div>
                    </div>
                </div>
            </div>
